package zy.library.ui.photopicker;
...
import zy.library.ui.photopicker.widget.ViewPagerFixed;
 ...
 */
public class PhotoPreviewActivity extends BaseZyActivity implements PhotoPagerAdapter.PhotoViewClickListener{
    ...
    public void onBackPressed() {
        if (StringUtils.isEmpty(getIntent().getStringExtra(IS_REVIEW))){
