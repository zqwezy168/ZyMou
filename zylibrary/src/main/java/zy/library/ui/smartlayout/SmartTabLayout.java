 ...
 */
package zy.library.ui.smartlayout;
 ...
 * alternative is via the {@link zy.library.view.smartlayout.SmartTabLayout.TabColorizer} interface which provides you complete control over
...
public class SmartTabLayout extends HorizontalScrollView {
     ...
     * {@link #setCustomTabColorizer(zy.library.view.smartlayout.SmartTabLayout.TabColorizer)}.
     */
     ...
     *
     * @param interpolator {@link zy.library.view.smartlayout.SmartTabIndicationInterpolator}
     */
    ...
    /**
     * Set the custom {@link zy.library.view.smartlayout.SmartTabLayout.TabColorizer} to be used.
     * <p>
    ...
    /**
     * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link zy.library.view.smartlayout} you are
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tabTitleView.setTextSize(14);//修改
