...
import zy.library.ui.chatLib.highlight.Range;
...
import zy.library.ui.chatLib.model.GradientColor;
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        for (int j = 0; j < buffer.size(); j += 4) {
            ...
            RectF rectF=new RectF(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2],
                    buffer.buffer[j + 3]);
            int radius = 10;
            c.drawRoundRect(rectF,(float)radius,(float)radius,mRenderPaint);
