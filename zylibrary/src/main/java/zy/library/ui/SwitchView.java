...
//        paint.setColor(isOn ? 0xff0fcbc8 : 0xffe3e3e3);
        paint.setColor(isOn ? getResources().getColor(R.color.theme_color) : 0xffe3e3e3);
...
//        paint.setColor(isOn ? 0xff0fcbc8 : 0xffbfbfbf);
        paint.setColor(isOn ? getResources().getColor(R.color.theme_color):0xffbfbfbf);
        canvas.drawPath(bPath, paint);
