...
public class MNImageBrowser {
     ...
     */
    public static void showImageBrowser(Activity context, View view, int position, int viewPagerTransformType, ArrayList<String> imageList) {
     ...
     * @param imageList 数据源ArrayList<String>
     */
    public static void showImageBrowser(Activity context, View view, int position, ArrayList<String> imageList) {
        Intent intent = new Intent(context, MNImageBrowserActivity.class);
        intent.putExtra(MNImageBrowserActivity.IntentKey_ImageList, imageList);
        intent.putExtra(MNImageBrowserActivity.IntentKey_CurrentPosition, position);
        startBrowserAvtivity(context, view, intent);
    ...
    private static void startBrowserAvtivity(Activity context, View view, Intent intent) {
