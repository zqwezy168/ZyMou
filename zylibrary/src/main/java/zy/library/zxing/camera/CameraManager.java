...
package zy.library.zxing.camera;
...
//					MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT);
            ...
            int width = 720 * screenResolution.x / 1080; //按设计实际为741
            int height = 720 * screenResolution.x / 1080;

            int leftOffset = (screenResolution.x - width) / 2;
            int topOffset = 420 * screenResolution.x / 1080; //按设计实际为400
